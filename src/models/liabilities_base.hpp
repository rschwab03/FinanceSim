...
/// Base class for liability models
/// Derive from this to create specific liability types (mortgage, loans, etc.)
class LiabilitiesBase : public Model {
public:
    LiabilitiesBase(std::string id, std::string name, Schedule schedule);
    virtual ~LiabilitiesBase() = default;
